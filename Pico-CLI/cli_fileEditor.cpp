...
void cmd_fmk(uint8_t argc, char* argv[]) {
  if (argc < 2) {
    Serial.println(F("cmd: mkfil <type> <filename>"));
...
void cmd_fwrt(uint8_t argc, char* argv[]) {
  if (argc < 2) {
    Serial.println(F("cmd: wrtfil <filename> \"content\""));
...
void cmd_frd(uint8_t argc, char* argv[]) {
  if (argc < 1) {
    Serial.println(F("cmd: rdfil <filename>"));
...
void cmd_fedt(uint8_t argc, char* argv[]) {
  if (argc < 3) {
    Serial.println(F("cmd: edtfil <-n | -r ->(*)> <filename> <index> \"text\"*"));
...
void cmd_frmv(uint8_t argc, char* argv[]) {
  if (argc < 1) {
    Serial.println("cmd: rmvfil <filename>");
...
void cmd_rmdir(uint8_t argc, char* argv[]) {
  if (argc < 2) {
    Serial.println("cmd: rmvdir <folder_name>");
...
void cmd_fsz(uint8_t argc, char* argv[]) {
  if (argc < 2) {
    Serial.println("cmd: szfil <filename>");
...
void cmd_frnm(uint8_t argc, char* argv[]) {
  if (argc < 3) {
    Serial.println("cmd: rnmfil <old_name> <new_name>");
